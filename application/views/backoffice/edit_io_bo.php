...
<div class="container text-center">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 bg-info d-flex justify-content-center align-items-center p-3">
                    <h4 class="text-white">EMPRESA CON EMPLEADOS RELACIÓN DEPENDENCIA</h4>
                </div>
                <div class="col-md-9">
    ...
    <div class="mb-3">
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 bg-info d-flex justify-content-center align-items-center p-3">
                    <h4 class="text-white">HABILITACIONES PROFESIONALES</h4>
                </div>
                <div class="col-md-9">
                    <div class="input-group mb-3">
						<div class="col-md-9">
    ...
    <div class="form-group" hidden>
		...
		<div class="col-md-8">
			<input type="text" name="idproveedor" value="<?php echo ($this->input->post('idproveedor') ? $this->input->post('idproveedor') : $docingresoobra['idproveedor']); ?>" class="form-control" id="idproveedor" />
		</div>
	</div>
