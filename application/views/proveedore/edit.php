<?php echo form_open('proveedor/edit/'.$proveedor['idproveedor'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="rubro" class="form-control">
				...
				{
					$selected = ($value == $proveedor['rubro']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="pass" value="<?php echo ($this->input->post('pass') ? $this->input->post('pass') : $proveedor['pass']); ?>" class="form-control" id="pass" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="empresa" value="<?php echo ($this->input->post('empresa') ? $this->input->post('empresa') : $proveedor['empresa']); ?>" class="form-control" id="empresa" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="apellidos" value="<?php echo ($this->input->post('apellidos') ? $this->input->post('apellidos') : $proveedor['apellidos']); ?>" class="form-control" id="apellidos" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="nombres" value="<?php echo ($this->input->post('nombres') ? $this->input->post('nombres') : $proveedor['nombres']); ?>" class="form-control" id="nombres" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="mail" value="<?php echo ($this->input->post('mail') ? $this->input->post('mail') : $proveedor['mail']); ?>" class="form-control" id="mail" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="subrubro" value="<?php echo ($this->input->post('subrubro') ? $this->input->post('subrubro') : $proveedor['subrubro']); ?>" class="form-control" id="subrubro" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="ciudad" value="<?php echo ($this->input->post('ciudad') ? $this->input->post('ciudad') : $proveedor['ciudad']); ?>" class="form-control" id="ciudad" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="web" value="<?php echo ($this->input->post('web') ? $this->input->post('web') : $proveedor['web']); ?>" class="form-control" id="web" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="observaciones" value="<?php echo ($this->input->post('observaciones') ? $this->input->post('observaciones') : $proveedor['observaciones']); ?>" class="form-control" id="observaciones" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="activo" value="<?php echo ($this->input->post('activo') ? $this->input->post('activo') : $proveedor['activo']); ?>" class="form-control" id="activo" />
		</div>
	</div>
	<div class="form-group">
		<label for="categoria" class="col-md-4 control-label">Categoria</label>
		<div class="col-md-8">
			<input type="text" name="categoria" value="<?php echo ($this->input->post('categoria') ? $this->input->post('categoria') : $proveedor['categoria']); ?>" class="form-control" id="categoria" />
		</div>
	</div>
