        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="input-group mb-3">
                        <div class="col">
                            <input type="text" name="lugarservicios"
                                value="<?php echo ($this->input->post('lugarservicios') ? $this->input->post('lugarservicios') : $formulariot['lugarservicios']); ?>"
                                class="form-control" id="lugarservicios" placeholder="Lugar donde presta Servicios" />
                        </div>
                    </div>
                    <div class="input-group mb-3">
                        <div class="col">
